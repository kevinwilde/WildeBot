...
class TestMancala(unittest.TestCase):
    ...
    def test_legal_moves_empty_board(self):
        m = MancalaBoard()
        m.P1Cups = [0] * m.num_cups
        m.P2Cups = [0] * m.num_cups
    ...
    def test_make_move_1(self):
        ...
        self.assertEqual(m.score_cups[0], 1)
        self.assertEqual(m.score_cups[1], 0)
    ...
    def test_clear_board_at_end(self):
        ...
        m.score_cups = [23, 0]
        m.make_move(1, 6)
        self.assertEqual(m.P1Cups, [0] * m.num_cups)
        self.assertEqual(m.P2Cups, [0] * m.num_cups)
        self.assertTrue(m.game_over())
